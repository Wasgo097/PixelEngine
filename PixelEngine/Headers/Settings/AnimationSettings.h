...
namespace Settings{
	...
	public:
		...
		AnimationSettings(sf::Vector2u rectsize, float switchtime, std::map<int, int> framescount) :_rectsize(rectsize), _switchtime(switchtime), _framescount(framescount){}
	...
	protected:
		...
		std::map<Core::Animation::Direction, int> directiontorow;
	};
}