...
namespace Core{
	Engine::Engine(){
		...
		//_enginesettings = Settings::EngineSettings(/*settingspath,*/ windowsettings, musicsettings, worldsettings);
		...
		//reader >> jsonmusic;
		//reader.close();
		//float master = jsonmusic["MasterVolume"];
		//float music = jsonmusic["MusicVolume"];
		//float effect = jsonmusic["EffectVolume"];
