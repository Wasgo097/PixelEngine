#include "Particle2Test.h"
#include <SFML/Window.hpp>
#include <SFML/Graphics/RenderWindow.hpp>
#include <SFML/Graphics/Text.hpp>
#include "ParticleSystem2.h"
namespace Test {
	Particle2Test::Particle2Test(const ArgumentParser& parser) :BaseTest(parser) {
	}

	bool Particle2Test::PrepareTest() {  /* Define desired resolution and open a window */
